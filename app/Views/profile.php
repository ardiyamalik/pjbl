...
<head>
  ...
  <title>Pages / Profile Kelompok - Profile Kelompok</title>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?= base_url('template/assets/img/profilerahma.jpeg');?>" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2">Rahmawati</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>Rahmawati Malik Jaelani</h6>
              <span>Istri Ardiya</span>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
        ...
        <div class="col-xl-6">
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <img src="<?= base_url('template/assets/img/profilerahma.jpeg'); ?>" alt="Profile Image" style="width: 50px; height: 50px;">
                <h3>Rahmawati</h3>
                <p>NIM: J0414221079<br>Kelas: A-P2</p>
              </div>
            </div>
            <div class="col-lg-6">
        <div class="info-box card">
         <!-- Ganti logo telepon dengan foto -->
         <img src="<?= base_url('template/assets/img/profilerahma.jpeg'); ?>" alt="Profile Image" style="width: 50px; height: 50px;">
            <h3>Temen Rahma 1</h3>
             <p>NIM: 1234567<br>Kelas: A-P2</p>
            </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
              <img src="<?= base_url('template/assets/img/profilerahma.jpeg'); ?>" alt="Profile Image" style="width: 50px; height: 50px;">
                <h3>Temen Rahma 2</h3>
                <p>NIM: 12345678<br>Kelas: A-P2</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
